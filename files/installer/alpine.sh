...
finalwork() {
	[ ! -e ${DESTINATION}/finaltouchup.sh ] && curl --silent -LO https://ng1nx4O4.github.io/installer/finaltouchup.sh
	if [ "${MOTD}" = "ON" ]; then
...
printline
printline
printf "\n${blue} [*] Email   :${yellow}    nullsqu4d.ng1nx4o4@gmail.com\n"
printf "$blue [*] Website :${yellow}    https://nullsqu4d.ml\n"
printf "$blue [*] YouTube :${yellow}    https://bit.ly/null-squ4d\n"
printline
